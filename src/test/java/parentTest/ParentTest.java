...
//                ,
    ...
    public void setUp() {
        ...
        if ("chrome".equals(browser)) {//стринга не может использовать ==, строка не может равняться браузеру т.к это адрес.
    ...
    protected void checkAcceptanceCriteria(String message, String actual, String expected){
        ...
        //utils.screenShot(pathToScreenShot, driver);
        //  }
        Assert.assertThat(message, actual, is (expected));//удобный метод для использования.
        isTestPass = true;
    }
